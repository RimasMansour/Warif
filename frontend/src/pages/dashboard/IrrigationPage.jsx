            ...
            <CardShell className="p-6 h-full card-interactive">
              ...
              {globalAutoMode ? (
                ...
                <div className="mt-6 flex flex-col gap-3">
                  ...
                  {showSuccess === "stop" && <div className="p-2 bg-red-50 text-red-700 rounded-xl border border-red-100 text-xs font-black flex items-center justify-center animate-pulse">{isEn ? "All Valves Closed" : "تم إغلاق كافة المحابس"}</div>}
                </div>
              )}
            </CardShell>
          </div>
