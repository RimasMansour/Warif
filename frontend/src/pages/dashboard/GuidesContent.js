      ...
      sections: [
        {
          ...
          content: "الصفحة الرئيسية تجمع كل شيء في مكان واحد: مركز قيادة التوأم الرقمي في الأعلى يوضح حالة الأجهزة والمعدات، وأربع بطاقات سريعة تعرض بيانات المناخ والتربة والري والتوصيات في الوقت الفعلي. بطاقة التنبيهات على اليسار ترصد أي اختلالات تلقائياً وتوصي بالإجراء المناسب."
        },
        {
          id: "automation",
