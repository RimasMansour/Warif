export function Footer({ isEn }) {
  ...
  return (
    <footer className="w-full mt-auto pt-5 pb-24 lg:pb-8 px-6 md:px-20 bg-transparent border-t border-gray-200/60 transition-all duration-300">
      <div className="w-full max-w-[1150px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-[13px] font-medium text-gray-500">
        ...
        {/* Links */}
        <div className="flex items-center gap-3 md:gap-5 flex-wrap justify-center text-[13px]">
