...
class PresentationFormatter:
    ...
    ALERT_MESSAGES = {
        ...
        'heat_stress': {
            'title': 'ارتفاع حرج في درجة الحرارة',
        ...
        'low_humidity': {
            ...
            'action': 'فعّل نظام الترطيب أو الرش',
            'urgency': 'خلال ساعتين',
            'reason': 'الجفاف الشديد يسبب جفاف الأوراق والزهور',
        },
        'anomaly_detected': {
            'title': 'قراءة غير طبيعية - خلل في الحساس',
            'action': 'تحقق من الحساس؛ فقد يكون معطلاً',
            'urgency': 'فوري',
            'reason': 'قد يؤدي لقرارات خاطئة إذا لم يتم التحقق',
        },
        'disease_risk': {
            'title': 'خطر الأمراض الفطرية - ظروف مناسبة للانتشار',
            'action': 'زد التهوية وقلل الرطوبة',
            'urgency': 'خلال ساعة',
            'reason': 'قد تنتشر الأمراض الفطرية بسرعة وتؤثر في صحة المحصول',
        },
    }
    ...
    RECOMMENDATION_MESSAGES = {
        ...
        'decrease_irrigation': {
            ...
            'suggestion': 'قلل تكرار الري أو مدته',
            'benefit': 'توفير المياه وتقليل خطر الأمراض',
            'timing': 'خلال الري القادم',
        },
        'improve_ventilation': {
            'title': '💡 تحسين التهوية',
            'insight': 'الرطوبة ودرجة الحرارة مرتفعتان',
            'suggestion': 'شغل المراوح بشكل مستمر',
            'benefit': 'تقليل خطر الأمراض الفطرية والحفاظ على صحة النبات',
            'timing': 'على الفور',
        },
        'monitor_carefully': {
            'title': '💡 مراقبة مكثفة',
        ...
        'optimize_schedule': {
            ...
            'suggestion': 'زيادة تكرار الري في هذا الوقت',
    ...
    def _generate_specific_reason(self, alert_type: str, device_name: Optional[str] = None, sensor_name: Optional[str] = None) -> str:
        ...
        reason_map = {
            'drought': f'حساس الرطوبة {device_info} يشير إلى جفاف التربة - يحتاج النبات إلى الري فوراً',
            'flooding': f'حساس الرطوبة {device_info} يشير إلى زيادة مفرطة في المياه - قد تتأثر صحة الجذور',
            'heat_stress': f'حساس الحرارة {device_info} يسجل درجة حرارة حرجة - الحرارة الزائدة قد تضر النبات',
            ...
            'low_humidity': f'حساس الرطوبة {device_info} يشير إلى انخفاض رطوبة الهواء - قد تتأثر الأوراق بالجفاف',
            'anomaly_detected': f'الحساس {device_info} يسجل قراءة غير طبيعية - قد يكون الحساس معطلاً أو توجد مشكلة في الاتصال',
            'disease_risk': f'الظروف المسجلة {device_info} مناسبة لتكاثر الأمراض الفطرية بسبب ارتفاع الرطوبة وتوفر حرارة ملائمة',
        }
