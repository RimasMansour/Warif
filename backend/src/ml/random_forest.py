...
random_forest.py
----------------
Random Forest model for irrigation prediction in Warif system.
This is the baseline model - other models are compared against it.
...
SCALER_PATH = MODELS_DIR / "rf_scaler.pkl"
...
def train(data_path: Path = DATA_PATH) -> dict:
    ...
    # Feature importance - tells us which sensor matters most
